...
import 'package:property_dealer_app/Common/models/model.dart' as model;
  ...
  void registerUser() async {
    ...
    try {
      ...
      bool phoneNumberExists =
          await isPhoneNumberAlreadyInUse(phonenumberController.text.trim());
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: MediaQuery.of(context).size.height *
                          0.06, // Adjust width with MediaQuery
